...
\textcite{Sklar1959} showed, that every d-variate distribution $F(x_1,\dots, x_n)$ can be expressed in terms of its marginal distributions $F_1(x), \dots, F_n(x)$ and a copula function $C(u_1, \dots, u_N)$ such that 
$$
\label{eq:sklar}
...
In contrast, linear correlation is dependend on both the copula and the marginal distributions \parencite[p. 768]{Patton2009}. 
...
\begin{tabular}{rlll}
  ...
  \midrule
  $\beta_1$ & 0.00 (0.07) & 1.87 (0.70) & 0.00 (0.14) \\ 
  $\beta_2$ & 1.14 (0.35) & 0.88 (0.29) & 1.18 (0.30) \\ 
  $\beta_3$ & 0.99 (0.32) & 0.83 (0.30) & 1.11 (0.26) \\ 
  $\beta_4$ & 0.01 (1.32) & 1.63 (0.69) & 0.89 (0.15) \\ 
  $\beta_5$ & 0.93 (0.20) & 1.01 (0.31) & 0.98 (0.18) \\ 
  $\beta_6$ & 1.03 (0.23) & 1.11 (0.37) & 1.04 (0.19) \\
  \midrule
  $Q$ & 0.0007 & 0.0027 & 0.0031 \\ 
  $T$ & 1000 & 500 & 1500 \\
  $S$ & 37500 & 37500 & 37500 \\
  \bottomrule
\end{tabular}
...
\begin{tabular}{rcccccc}
  \toprule
 party & posts & accounts & likes & shares & weighted (\%) & non-weighted (\%) \\ 
 & & &\multicolumn{2}{c} {(in Million)} &  \multicolumn{2}{c} {share of posts related to "refugees"}\\ 
\cmidrule(r){1-1} \cmidrule(lr){2-3} \cmidrule(lr){4-5}  \cmidrule(l){6-7}
AfD & 74724 & 162 & 18.36 & 7.59 & 8.14 & 6.96 \\ 
  CDU/CSU & 169115 & 267 & 14.72 & 1.83 & 3.67 & 3.49 \\ 
  FDP & 71083 & 201 & 6.32 & 0.77 & 2.83 & 2.39 \\ 
  Grüne & 67188 & 139 & 4.03 & 1.28 & 5.07 & 4.62 \\ 
  Linke & 84723 & 158 & 16.03 & 4.23 & 6.97 & 6.23 \\ 
  SPD & 196805 & 290 & 10.11 & 1.57 & 3.96 & 3.66 \\ 
\cmidrule(r){1-1} \cmidrule(lr){2-3} \cmidrule(lr){4-5}  \cmidrule(l){6-7}
  All parties & \numprint{663638} & 1217 & 69.57 & 17.27 &  4.86 & 4.28\\
  \bottomrule
\end{tabular}
\caption{Overall number of posts, active accounts, likes and shares over the observation period from "2014-01-01" - "2017-12-31". The last two columns show the (weighted) fraction of posts matching the regular expression \texttt{flucht|fluecht}. The number of shares, comments and likes are used as weights.}
\label{t:facebook}
\end{table}
...
\begin{tabular}{rcccc}
  \toprule
  & \multicolumn{2}{c}{Moments based test}& \multicolumn{2}{c}{Copula based test} \\ 
  & unrestrictive & restrictive & unrestrictive & restrictive \\
  \cmidrule(r){1-1} \cmidrule(lr){2-3} \cmidrule(l){4-5}
  test statistics & 26.85 & 466.26 &  -&  -  \\ 
  critical value  &      0.72 &      101.80 &      - & - \\ 
  breakpoint      &  2016-04-24    &  2016-04-24  &      - & - \\ 
  \bottomrule
\end{tabular}
