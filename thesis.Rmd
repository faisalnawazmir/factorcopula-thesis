...
Third, for each party and day we count the relative number of posts related to the refugee crisis. Thus, the resulting dataset consists of a column for each party where each row represent the relative frequency of a day (compare to Figure \ref{f:residuals} in the Appendix).  
